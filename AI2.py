...
#By the book AI with changed probabilities but a random number of simulations between 50 and 30000
class AI2:
    def __init__(self): 
    ...
    sims = random.randint(50,30000)        
    
    def simulation(self, player, centerCards, numOpponents, monteCarloRuns = sims):
        wins = 0
